...
let userID = 'a26c1132-d67e-43e8-91db-95233bb14c41';

const proxyIPs = ["103.184.44.34"]; // const proxyIPs = ['cdn-all.xn--b6gac.eu.org', 'cdn.xn--b6gac.eu.org', 'cdn-b100.xn--b6gac.eu.org', 'edgetunnel.anycast.eu.org', 'cdn.anycast.eu.org'];
            ...
            if (!upgradeHeader || upgradeHeader !== 'websocket') {
                ...
                switch (url.pathname) {
                    ...
                    default:
                        ...
                        // For any other path, reverse proxy to 'autopatchcn.yuanshen.com' and return the original response
                        url.hostname = 'autopatchcn.yuanshen.com';
                        url.protocol = 'https:';
